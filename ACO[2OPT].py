...
class AC:
    ...
    def _acs(self):
        for step in range(self.steps):
            ...
            # 2OPT
            initial_tour, self.global_best_tour, init_coast, self.global_best_distance = solve_tsp_2opt(self.weights,
    ...
    def _max_min(self):
        for step in range(self.steps):
            ...
            # 2OPT
            initial_tour, iteration_best_tour, init_coast, iteration_best_distance = solve_tsp_2opt(self.weights,
                                                                                                    iteration_best_tour)
            #########
